...
CREATE TABLE `t_order_detail`  (
  ...
  `od_price_total` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `od_price_pledge` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `od_price_balance` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `od_price_1st` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `od_price_2nd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `od_price_last` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
