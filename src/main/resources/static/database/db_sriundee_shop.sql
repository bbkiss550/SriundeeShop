...
INSERT INTO `t_artist` VALUES (8, 'CLOSE YOUR EYES', '5', 'https://pbs.twimg.com/profile_images/1981315204878049280/78owTDr5_400x400.jpg', 'D');
...
CREATE TABLE `t_order`  (
  ...
  `o_last_pay_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (1, 'bbkiss550', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_payment_method`  (
  ...
  `pm_delete` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
